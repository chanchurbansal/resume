...
\workplace{Utopia Innovations Pvt. Ltd.}{May 2017 – July 2017}\\
\position{Software Engineering Intern}{Saket, New Delhi}
...
\runsubsection{Navigation} \uhref{https://github.com/Minor-Navigation}{Link to Project}
\descript{}
...
\runsubsection{Dr. Smart} \uhref{https://github.com/DrSmart-Minor/DrSmart}{Link to Project}
\descript{}
...
\runsubsection{Django Login Authentication Api} \uhref{https://github.com/chanchurbansal/DjangoLoginAuthAPI}{Link to Project}
\descript{}
A Django Api to authenticate login using custom user model.
\sectionsep 

\runsubsection{Cricket Manager} \uhref{https://github.com/chanchurbansal/Cricket--Live-Score}{Link to Project}
\descript{}
A utility software in C language, for an ongoing cricket league to keep record and analyze past matches.
\sectionsep 

\runsubsection{JIIT Medical} %\uhref{}{Link to Project}
\descript{}
A Database (MySQL) and Web Designing (PHP, CSS, and HTML) project to provide nearest medical assistance for patients.
\sectionsep

\runsubsection{Web Kiosk} %\uhref{}{Link to Project}
\descript{}
...
\runsubsection{8085 Simulator} \uhref{https://github.com/chanchurbansal/8085-Emulator}{Link to Project}
\descript{}
